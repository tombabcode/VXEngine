...
public class Sprite : GameObjectV2 {
    ...
    public Sprite(BasicContentController content, BasicConfigController config, GameObjectV2 parent, TextureInstance texture, float x, float y, float width, float height) : base(config) {
        _content = content;
    ...
    public Sprite(BasicContentController content, BasicConfigController config, GameObjectV2 parent, TextureBase texture, float x, float y, float width, float height)
        : this(content, config, parent, texture?.GetInstance( ), x, y, width, height) { }
    public Sprite(BasicContentController content, BasicConfigController config, GameObjectV2 parent, TextureInstance texture, float width, float height)
        : this(content, config, parent, texture, 0, 0, width, height) { }
    public Sprite(BasicContentController content, BasicConfigController config, GameObjectV2 parent, TextureBase texture, float width, float height)
        : this(content, config, parent, texture?.GetInstance( ), 0, 0, width, height) { }
    public Sprite(BasicContentController content, BasicConfigController config, GameObjectV2 parent, TextureInstance texture)
        : this(content, config, parent, texture, 0, 0, -1, -1) { }
    public Sprite(BasicContentController content, BasicConfigController config, TextureBase texture, float x, float y, float width, float height)
        : this(content, config, null, texture?.GetInstance( ), x, y, width, height) { }
    public Sprite(BasicContentController content, BasicConfigController config, TextureInstance texture, float width, float height)
        : this(content, config, null, texture, 0, 0, width, height) { }
    public Sprite(BasicContentController content, BasicConfigController config, TextureBase texture, float width, float height)
        : this(content, config, null, texture?.GetInstance( ), 0, 0, width, height) { }
    public Sprite(BasicContentController content, BasicConfigController config, TextureInstance texture)
        : this(content, config, null, texture, 0, 0, -1, -1) { }
