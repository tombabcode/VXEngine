...
/// </summary>
public abstract class GameObjectOld {
    ...
    /// Parent object
    /// </summary>
    protected GameObjectOld? _parent;

    /// <summary>
    /// Children objects
    /// </summary>
    protected List<GameObjectOld> _children;
    ...
    public List<Action<GameObjectOld>> OnHoverIn { get; private set; } = new List<Action<GameObjectOld>>( );
    public List<Action<GameObjectOld>> OnHoverOut { get; private set; } = new List<Action<GameObjectOld>>( );
    public List<Action<GameObjectOld>> OnClick { get; private set; } = new List<Action<GameObjectOld>>( );
    public List<Action<GameObjectOld>> OnPress { get; private set; } = new List<Action<GameObjectOld>>( );
    public List<Action<GameObjectOld>> OnRelease { get; private set; } = new List<Action<GameObjectOld>>( );
    ...
    /// Constructor
    /// </summary>
    public GameObjectOld(BasicInputController input) {
        _input = input;
        _children = new List<GameObjectOld>( );
    }
    ...
    /// </summary>
    /// <returns></returns>
    public virtual GameObjectOld? GetParent( ) { return _parent; }

    /// <summary>
    /// Get children
    /// </summary>
    /// <returns></returns>
    public virtual List<GameObjectOld> GetChildren( ) { return _children; }
    ...
    public virtual void SetParent(GameObjectOld? parent) {
    ...
    public virtual bool ContainsChild(GameObjectOld child) {
    ...
    public virtual void AddChild(GameObjectOld child) {
    ...
    /// </summary>
    /// <param name="child">Child</param>
    public virtual void RemoveChild(GameObjectOld child) {
        if (ContainsChild(child)) {
